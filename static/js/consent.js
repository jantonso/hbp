...
$(document).ready(function() {
	...
	$('form .text-fields #id_participant_month').on('keypress', function(event) {
	...
	// Auto tab date fields as the user types
	$('form .text-fields #id_participant_day').on('keypress', function(event) {
		// Make sure it is a numeric value or backspace, delete, tab, escape, enter
		if (event.charCode >= 48 && event.charCode <= 57) {
			if ($(this).val().length == 1) {
				$(this).next('input').focus();
	...
	$('form .text-fields #id_participant_year').on('keypress', function(event) {
		// Make sure it is a numeric value or backspace, delete, tab, escape, enter
		if (event.charCode >= 48 && event.charCode <= 57) {
	...
	// Auto tab date fields as the user types
	$('form .text-fields #id_obtaining_month').on('keypress', function(event) {
		// Make sure it is a numeric value or backspace, delete, tab, escape, enter
		if (event.charCode >= 48 && event.charCode <= 57) {
			if ($(this).val().length == 1) {
				$(this).next('input').focus();
	...
	// Auto tab date fields as the user types
	$('form .text-fields #id_obtaining_day').on('keypress', function(event) {
		// Make sure it is a numeric value or backspace, delete, tab, escape, enter
		if (event.charCode >= 48 && event.charCode <= 57) {
			if ($(this).val().length == 1) {
				$(this).next('input').focus();
	...
	$('form .text-fields #id_obtaining_year').on('keypress', function(event) {
		// Make sure it is a numeric value or backspace, delete, tab, escape, enter
		if (event.charCode >= 48 && event.charCode <= 57) {
			if ($(this).val().length == 3) {
				$('form .text-fields #id_obtaining_role').focus();
			}
		} else if ($.inArray(event.keyCode, [46, 8, 9, 27, 13, 110, 190]) == -1) {
			event.preventDefault();
		}
